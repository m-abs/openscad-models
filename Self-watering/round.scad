...
module model()
{
    ...
    {
        xrot(90) cyl(h = inner_diameter, r = water_hole_r, $fn = 8);
    }
    ...
    module water_hole()
    {
        ...
        hole_size = (water_hole_r + outer_wall);
    ...
    module water_funnel()
    {
        ...
        up(inner_height * 2 - 14) cuboid([ water_input_size, water_input_size, water_input_height ],
